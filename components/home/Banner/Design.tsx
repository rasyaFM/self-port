...
export default function Design() {
  return (
    <div className="design rounded-box bg-slate-500 p-5 text-black">
        <div className="ml-7">
            <h6 className="mt-2 italic">as Designer</h6>
            <h2 className="text-3xl font-semibold">All My Design</h2>
